...
public class CreateRestAPI {
	...
	/**
	 * Sample class that makes API request to employee database
	 *
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Request user to identify the employee first name
			System.out.println("Please enter in the employee's first name?");
			String firstName = sc.nextLine();

			// Request user to identify the employee last name
			System.out.println("Please enter in the employee's last name?");
			String lastName = sc.nextLine();

			// Request user to identify the employee email
			System.out.println("Please enter in the employee's email?");
			String email = sc.nextLine();

			// Request user to identify the employee home phone
			System.out
					.println("Please enter in the employee's home phone? (***Must be in this format: XXX-XXX-XXXX***)");
			String homePhone = sc.nextLine();

			// Request user to identify the employee cell phone
			System.out
					.println("Please enter in the employee's cell phone? (***Must be in this format: XXX-XXX-XXXX***)");
			String cellPhone = sc.nextLine();

			// Request user to identify the employee password
			System.out.println(
					"Please enter in the employee's password (***Alphanumeric only, 8 charaters total, with at least 1 capital letter and 1 number***)?");
			String password = sc.nextLine();

			// Request user to identify the employee status
			System.out.println(
					"Please enter in the employee's status (***1 for active employee, 0 for inactive employee***)?");
			...
			URL localSite = new URL(endpoint + "?" + queryString);
